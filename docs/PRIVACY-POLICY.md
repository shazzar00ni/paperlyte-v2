...
- We do NOT read the content of your notes for marketing purposes
- We do NOT track your browsing activity outside Paperlyte
...
- **Browser Settings**: Block or delete cookies via browser settings
- **Opt-Out**: Disable analytics cookies in app settings
...
Paperlyte is not intended for children under 13 (or 16 in the EU).

- We do not knowingly collect data from children
- If we learn we've collected child data, we delete it immediately
- Parents can contact us to delete their child's data
...
**By using Paperlyte, you agree to this Privacy Policy.**

If you don't agree with this policy, please don't use our service.
