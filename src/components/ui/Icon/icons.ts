...
export const iconPaths: Record<string, string> = {
  ...
  'fa-rotate-right': 'M23 4v6h-6 M1 20v-6h6 M3.51 9a9 9 0 0 1 14.85-3.36L23 10 M1 14l4.64 4.36A9 9 0 0 0 20.49 15',
  ...
  'fa-note-sticky':
    'M7 3a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h10l5-5V5a2 2 0 0 0-2-2H7z M17 3v6h5',

  // Pricing Plan Icons
  'fa-leaf':
    'M2 2l8 8a7 7 0 1 0 10-10A15 15 0 0 0 2 2 M2 22l8-8',
  'fa-rocket':
