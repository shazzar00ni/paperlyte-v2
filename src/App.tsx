      ...
      <ErrorBoundary>
        ...
        <main id="main" tabIndex={-1} ref={mainRef}>
          ...
          <ErrorBoundary fallback={<></>}>
            <Suspense
              fallback={
                <div className="suspense-statistics" role="status">
          ...
          <ErrorBoundary fallback={<></>}>
            <Suspense
              fallback={
                <div className="suspense-comparison" role="status">
          ...
          <ErrorBoundary fallback={<></>}>
            <Suspense
              fallback={
                <div className="suspense-testimonials" role="status">
          ...
          <ErrorBoundary fallback={<></>}>
            <Suspense
              fallback={
                <div className="suspense-email-capture" role="status">
          ...
          <ErrorBoundary fallback={<></>}>
            <Suspense
              fallback={
                <div className="suspense-faq" role="status">
          ...
          <ErrorBoundary fallback={<></>}>
            <Suspense
              fallback={
                <div className="suspense-cta" role="status">
                  <span className="sr-only">Loading call to action…</span>
                </div>
              }
            >
              <CTA />
        ...
        <Suspense
          fallback={
            <div className="suspense-feedback" role="status">
              <span className="sr-only">Loading feedback widget…</span>
            </div>
          }
        >
          <FeedbackWidget />
