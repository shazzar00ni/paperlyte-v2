...
describe('Icon', () => {
  ...
  it('should render Font Awesome fallback for missing icons', () => {
    ...
    // Should render fallback element (span or svg with icon-fallback class)
  ...
  it('should render as SVG element or fallback to Font Awesome', () => {
    ...
    // Component may render as SVG (if icon exists in icon set) or as fallback with icon-fallback class
  ...
  it('should apply correct variant class for solid', () => {
    ...
    // Since missing-icon is not found, it renders a fallback span with icon-fallback class
    expect(fallback).toBeInTheDocument()
  })
