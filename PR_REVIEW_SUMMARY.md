...
- **Summary:** An automated repository-wide audit of 256 unmerged branches confirms the following systemic regressions.

| Regression Type                | Count | Severity    | Notes                                               |
| :----------------------------- | :---- | :---------- | :-------------------------------------------------- |
| Orphan Branches                | 256   | 🔴 Critical | No common ancestor with `main`.                     |
