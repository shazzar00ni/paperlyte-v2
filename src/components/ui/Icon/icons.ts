...
//
// Keys must match the output of convertIconName() (i.e. the value stored in
// iconNameMap, or the icon name with the leading "fa-" stripped).
...
export const iconPaths: Record<string, string> = {
  ...
  // fa-wifi-slash maps to 'plane-slash' in iconNameMap (offline indicator)
  'plane-slash':
  ...
  'pen-nib': 'M12 19l7-7 3 3-7 7-3-3z M18 13l-1.5-7.5L2 2l3.5 14.5L13 18l5-5z M2 2l7.586 7.586',
  ...
  lightbulb: 'M9 18h6 M10 22h4 M15 8a3 3 0 0 0-6 0c0 2 2 3 2 5v1h2v-1c0-2 2-3 2-5z M12 2v1',
