...
describe("Comparison", () => {
  ...
  it("should render all comparison features", () => {
    ...
    COMPARISON_FEATURES.forEach((feature) => {
      expect(
        screen.getByRole("rowheader", { name: feature.feature }),
      ).toBeInTheDocument();
    });
  });
  ...
  it("should render specific comparison feature: Startup Time", () => {
    ...
    expect(
      screen.getByRole("rowheader", { name: "Startup Time" }),
    ).toBeInTheDocument();
  ...
  it("should render specific comparison feature: Offline Access", () => {
    ...
    expect(
      screen.getByRole("rowheader", { name: "Offline Access" }),
    ).toBeInTheDocument();

    // Should have checkmarks for true values
    const offlineRow = screen
      .getByRole("rowheader", { name: "Offline Access" })
      .closest("tr");
  ...
  it("should render specific comparison feature: End-to-End Encryption", () => {
    ...
    expect(
      screen.getByRole("rowheader", { name: "End-to-End Encryption" }),
    ).toBeInTheDocument();
  });
});
