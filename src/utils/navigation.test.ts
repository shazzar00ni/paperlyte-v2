...
describe('navigation utilities', () => {
  ...
  describe('safeNavigate', () => {
    ...
    // --- External HTTPS URLs (blocked to prevent open redirects) ---

    it('should block external HTTPS URL (open redirect protection)', () => {
      mockLocation()
    ...
    it('should block external HTTPS URL with path (open redirect protection)', () => {
      mockLocation()
      const warnSpy = vi.spyOn(console, 'warn').mockImplementation(() => {})
    ...
    it('should block external HTTP URL (open redirect protection)', () => {
      mockLocation()
      const warnSpy = vi.spyOn(console, 'warn').mockImplementation(() => {})
