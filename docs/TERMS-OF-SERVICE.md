...
By accessing or using Paperlyte ("the Service"), you agree to be bound by these Terms of Service ("Terms"). If you disagree with any part of these terms, you may not access the Service.

**Important:** These Terms contain a mandatory arbitration provision and class action waiver in Section 15. Please read this carefully.
...
- Store illegal content (CSAM, terrorism, etc.)
...
- Infringe on copyrights, trademarks, or other IP rights
...
You're responsible for all taxes associated with your subscription, except taxes on our net income.
...
- Account deleted after 60 days of non-payment (with 30-day warning)
...
**You own your data.** We're merely a custodian.
...
- The Service is free of malware
...
- Any claims by others arising from your actions

This includes legal fees and costs.
...
By using beta features, you acknowledge these risks.
...
Cancel your account anytime from settings.

- Access continues until end of billing period
- Data available for 30 days after cancellation
...
- Non-payment
- Extended inactivity (Free accounts: 12 months, with 30-day notice)
...
**Survival:** Sections 4, 7, 8, 9, 10, 15, and 16 survive termination.
...
If the class action waiver is found unenforceable, the arbitration provision remains in effect.
...
These Terms, our Privacy Policy, and any referenced documents constitute the entire agreement.
...
You cannot assign these Terms. We may assign them with 30 days' notice.

### 16.7 Force Majeure

We're not liable for failures caused by events beyond our control (natural disasters, wars, pandemics, government actions, etc.).
...
If you're a US government user, Paperlyte is a "Commercial Item" with "Restricted Rights."

### 16.10 Translations

English version controls in case of conflicts with translations.
...
**By creating an account or using Paperlyte, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.**
